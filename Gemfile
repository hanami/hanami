...
gem 'i18n'
gem 'hanami-utils',       '~> 1.0', require: false, git: 'https://github.com/hanami/utils.git',       branch: 'files'
...
gem 'hanami-cli',         '~> 1.0', require: false, git: 'https://github.com/hanami/cli.git',         branch: 'initial-cleanup'
