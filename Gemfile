...
gem 'i18n'
gem 'hanami-utils',       '~> 1.0.0.beta1', require: false, github: 'hanami/utils',       branch: 'tagged-logger'
...
gem 'hanami-model',       '~> 1.0.0.beta1', require: false, github: 'hanami/model',       branch: 'logger-setter'
