...
module CoffeeShop
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['COFFEE_SHOP_SESSIONS_SECRET']
      ...
      # Configure the code that will yield each time CoffeeShop::Action is included
      ...
      # Configure the code that will yield each time CoffeeShop::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include CoffeeShop::Assets::Helpers
      end
    end
