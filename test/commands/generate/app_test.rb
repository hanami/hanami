  ...
  describe 'with valid arguments' do
    ...
    it 'create files' do
      with_temp_dir do |original_wd|
        ...
        assert_file_exists('apps/api/controllers/.keep')
        assert_file_exists('apps/api/assets/favicon.ico')
        assert_file_exists('apps/api/assets/images/.keep')
        assert_file_exists('apps/api/assets/javascripts/.keep')
        assert_file_exists('apps/api/assets/stylesheets/.keep')
        assert_file_exists('spec/api/features/.keep')
        assert_file_exists('spec/api/controllers/.keep')
        assert_file_exists('spec/api/views/.keep')
  ...
  describe '#destroy' do
    it 'destroys destroy an application, along with templates and specs' do
      with_temp_dir do |original_wd|
        ...
        refute_file_exists('apps/api/controllers/.keep')
        refute_file_exists('apps/api/public/javascripts/.keep')
        refute_file_exists('apps/api/public/stylesheets/.keep')
        refute_file_exists('spec/api/features/.keep')
        refute_file_exists('spec/api/controllers/.keep')
        refute_file_exists('spec/api/views/.keep')
