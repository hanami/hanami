...
describe Hanami::Commands::New::App do
  ...
  def assert_generated_app(test_framework, original_wd)
    ...
    Dir.chdir('new_app') do
      ...
      assert_file_exists('app/controllers/.keep')
      assert_file_exists('app/views/.keep')
      assert_file_exists('app/assets/favicon.ico')
      assert_file_exists('app/assets/javascripts/.keep')
      assert_file_exists('app/assets/stylesheets/.keep')
      assert_file_exists('app/assets/images/.keep')
      assert_file_exists('config/initializers/.keep')
      assert_file_exists('lib/new_app/entities/.keep')
      assert_file_exists('lib/new_app/repositories/.keep')
      assert_file_exists('lib/new_app/mailers/.keep')
      assert_file_exists('lib/new_app/mailers/templates/.keep')
      assert_file_exists('public/.keep')
      assert_file_exists('db/.keep')
      assert_file_exists('spec/features/.keep')
      assert_file_exists('spec/controllers/.keep')
      assert_file_exists('spec/views/.keep')
      assert_file_exists('spec/new_app/entities/.keep')
      assert_file_exists('spec/new_app/repositories/.keep')
      assert_file_exists('spec/new_app/mailers/.keep')
